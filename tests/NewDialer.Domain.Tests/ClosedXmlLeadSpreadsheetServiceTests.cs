...
public sealed class ClosedXmlLeadSpreadsheetServiceTests
{
    ...
    [Fact]
    public async Task ReadLeadsAsync_throws_when_required_column_missing()
    {
        using var stream = BuildWorkbook(
            ["Name", "Email", "Phone No", "Website", "Service"],
            ["Atlas Growth", "hello@atlas.test", "+1 415 555 0001", "atlas.test", "SEO"]);
